...
function setParameters(params) {
  ...
  if (params.showLoaderOnConfirm && !params.preConfirm) {
    warn('showLoaderOnConfirm is set to true, but preConfirm is not defined.\n' + 'showLoaderOnConfirm should be used together with preConfirm, see usage example:\n' + 'https://sweetalert.github.io/#ajax-request');
  }
}
...
function SweetAlert() {
  ...
  if (typeof Promise === 'undefined') {
    error('This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert/sweetalert/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)');
  }
